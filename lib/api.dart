...
part 'model/add_downstream_message_body.dart';
part 'model/any.dart';
part 'model/assign_target_image_response.dart';
...
part 'model/create_certificate_body.dart';
part 'model/create_certificate_response.dart';
part 'model/create_collection_request.dart';
part 'model/create_device_body.dart';
part 'model/create_firmware_body.dart';
part 'model/create_gateway_body.dart';
part 'model/create_labeled_firmware_response.dart';
part 'model/create_output_body.dart';
...
part 'model/device_image_state.dart';
...
part 'model/get_image_state_response.dart';
part 'model/image_state.dart';
part 'model/image_version_entry.dart';
part 'model/inet_metadata.dart';
part 'model/labeled_firmware.dart';
...
part 'model/list_image_states_response.dart';
part 'model/list_image_version_history_response.dart';
part 'model/list_labeled_firmware_response.dart';
...
part 'model/sign_certificate_body.dart';
part 'model/sign_certificate_response.dart';
part 'model/system_info_response.dart';
part 'model/udp_metadata.dart';
part 'model/update_collection_body.dart';
part 'model/update_device_body.dart';
part 'model/update_firmware_body.dart';
part 'model/update_gateway_body.dart';
part 'model/update_output_body.dart';
part 'model/verify_certificate_body.dart';
