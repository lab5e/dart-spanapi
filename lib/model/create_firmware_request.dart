...
class CreateFirmwareRequest {
  ...
  @override
  String toString() =>
      'CreateFirmwareRequest[collectionId=$collectionId, image=$image, version=$version, filename=$filename, tags=$tags]';
  ...
  static CreateFirmwareRequest fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : CreateFirmwareRequest(
    ...
    bool growable,
      ...
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <CreateFirmwareRequest>[]
          : json
              .map((v) => CreateFirmwareRequest.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, CreateFirmwareRequest> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, CreateFirmwareRequest>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = CreateFirmwareRequest.fromJson(v));
    }
    return map;
  }
  ...
  static Map<String, List<CreateFirmwareRequest>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = CreateFirmwareRequest.listFromJson(v,
