...
class ListDataResponse {
  ...
  static List<ListDataResponse> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <ListDataResponse>[]
      : json.map((v) => ListDataResponse.fromJson(v)).toList(growable: true == growable);

  static Map<String, ListDataResponse> mapFromJson(Map<String, dynamic> json) {
    final map = <String, ListDataResponse>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = ListDataResponse.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ListDataResponse-objects as value to a dart map
  static Map<String, List<ListDataResponse>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ListDataResponse>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ListDataResponse.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
