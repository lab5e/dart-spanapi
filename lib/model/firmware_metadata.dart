...
class FirmwareMetadata {
  ...
  static List<FirmwareMetadata> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <FirmwareMetadata>[]
      : json.map((v) => FirmwareMetadata.fromJson(v)).toList(growable: true == growable);

  static Map<String, FirmwareMetadata> mapFromJson(Map<String, dynamic> json) {
    final map = <String, FirmwareMetadata>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = FirmwareMetadata.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of FirmwareMetadata-objects as value to a dart map
  static Map<String, List<FirmwareMetadata>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<FirmwareMetadata>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = FirmwareMetadata.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
