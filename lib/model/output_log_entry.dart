...
class OutputLogEntry {
  ...
  static List<OutputLogEntry> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <OutputLogEntry>[]
      : json.map((v) => OutputLogEntry.fromJson(v)).toList(growable: true == growable);

  static Map<String, OutputLogEntry> mapFromJson(Map<String, dynamic> json) {
    final map = <String, OutputLogEntry>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = OutputLogEntry.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of OutputLogEntry-objects as value to a dart map
  static Map<String, List<OutputLogEntry>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<OutputLogEntry>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = OutputLogEntry.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
