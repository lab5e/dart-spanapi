...
class ClearFirmwareErrorResponse {
  ...
  @override
  int get hashCode => (result == null ? 0 : result.hashCode);
  ...
  static ClearFirmwareErrorResponse fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : ClearFirmwareErrorResponse(
    ...
    bool growable,
      ...
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <ClearFirmwareErrorResponse>[]
          : json
              .map((v) => ClearFirmwareErrorResponse.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, ClearFirmwareErrorResponse> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, ClearFirmwareErrorResponse>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = ClearFirmwareErrorResponse.fromJson(v));
    }
    return map;
  }
  ...
  static Map<String, List<ClearFirmwareErrorResponse>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ClearFirmwareErrorResponse.listFromJson(v,
