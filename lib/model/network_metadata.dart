...
class NetworkMetadata {
  ...
  static List<NetworkMetadata> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(NetworkMetadata.fromJson).toList(growable: true == growable)
  ...
  static Map<String, NetworkMetadata> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = NetworkMetadata.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of NetworkMetadata-objects as value to a dart map
  static Map<String, List<NetworkMetadata>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
