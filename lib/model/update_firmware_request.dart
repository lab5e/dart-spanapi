...
class UpdateFirmwareRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateFirmwareRequest &&
  ...
  @override
  String toString() => 'UpdateFirmwareRequest[collectionId=$collectionId, version=$version, tags=$tags]';
  ...
  static List<UpdateFirmwareRequest> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(UpdateFirmwareRequest.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <UpdateFirmwareRequest>[];
  ...
  static Map<String, UpdateFirmwareRequest> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = UpdateFirmwareRequest.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of UpdateFirmwareRequest-objects as value to a dart map
  static Map<String, List<UpdateFirmwareRequest>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
