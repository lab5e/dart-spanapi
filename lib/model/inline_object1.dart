...
class InlineObject1 {
  ...
  @override
  String toString() =>
      'InlineObject1[name=$name, collectionId=$collectionId, type=$type, config=$config, tags=$tags]';
  ...
  static List<InlineObject1> listFromJson(
    dynamic json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, InlineObject1> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = InlineObject1.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of InlineObject1-objects as value to a dart map
  static Map<String, List<InlineObject1>> mapListFromJson(
    dynamic json, {
    bool emptyIsNull,
    bool growable,
  }) {
