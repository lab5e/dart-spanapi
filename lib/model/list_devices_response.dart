...
class ListDevicesResponse {
  ...
  @override
  int get hashCode => (devices == null ? 0 : devices.hashCode);
    ...
    bool growable,
      ...
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <ListDevicesResponse>[]
          : json
              .map((v) => ListDevicesResponse.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, ListDevicesResponse> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, ListDevicesResponse>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = ListDevicesResponse.fromJson(v));
    }
    return map;
  }
  ...
  static Map<String, List<ListDevicesResponse>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ListDevicesResponse.listFromJson(v,
