...
class SendMessageRequest {
  ...
  @override
  String toString() => 'SendMessageRequest[collectionId=$collectionId, deviceId=$deviceId, port=$port, payload=$payload, transport=$transport, coapPath=$coapPath]';
  ...
  static List<SendMessageRequest> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <SendMessageRequest>[]
      : json.map((v) => SendMessageRequest.fromJson(v)).toList(growable: true == growable);

  static Map<String, SendMessageRequest> mapFromJson(Map<String, dynamic> json) {
    final map = <String, SendMessageRequest>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = SendMessageRequest.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of SendMessageRequest-objects as value to a dart map
  static Map<String, List<SendMessageRequest>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<SendMessageRequest>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = SendMessageRequest.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
