...
class Collection {
  ...
  @override
  String toString() =>
      'Collection[collectionId=$collectionId, teamId=$teamId, fieldMask=$fieldMask, firmware=$firmware, tags=$tags]';
  ...
  static Map<String, Collection> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = Collection.fromJson(v));
    }
    return map;
  }
  ...
  static Map<String, List<Collection>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = Collection.listFromJson(v,
