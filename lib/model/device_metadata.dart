...
class DeviceMetadata {
  ...
  static List<DeviceMetadata> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <DeviceMetadata>[]
      : json.map((v) => DeviceMetadata.fromJson(v)).toList(growable: true == growable);

  static Map<String, DeviceMetadata> mapFromJson(Map<String, dynamic> json) {
    final map = <String, DeviceMetadata>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = DeviceMetadata.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of DeviceMetadata-objects as value to a dart map
  static Map<String, List<DeviceMetadata>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<DeviceMetadata>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = DeviceMetadata.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
