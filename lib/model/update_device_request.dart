...
class UpdateDeviceRequest {
  ...
  @override
  String toString() =>
      'UpdateDeviceRequest[existingCollectionId=$existingCollectionId, deviceId=$deviceId, collectionId=$collectionId, imsi=$imsi, imei=$imei, tags=$tags, firmware=$firmware]';
    ...
    bool growable,
      ...
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <UpdateDeviceRequest>[]
          : json
              .map((v) => UpdateDeviceRequest.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, UpdateDeviceRequest> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, UpdateDeviceRequest>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = UpdateDeviceRequest.fromJson(v));
    }
    return map;
  }
  ...
  static Map<String, List<UpdateDeviceRequest>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = UpdateDeviceRequest.listFromJson(v,
