...
class MessageUpstream {
  ...
  @override
  String toString() =>
      'MessageUpstream[messageId=$messageId, collectionId=$collectionId, deviceId=$deviceId, gatewayId=$gatewayId, transport=$transport, received=$received, payload=$payload]';
