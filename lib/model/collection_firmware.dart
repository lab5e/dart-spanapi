...
class CollectionFirmware {
  ...
  static CollectionFirmware fromJson(Map<String, dynamic> json) => json == null
    ...
    : CollectionFirmware(
        ...
        management: CollectionFirmwareFirmwareManagement.fromJson(json[r'management']),
    );

  static List<CollectionFirmware> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <CollectionFirmware>[]
      : json.map((v) => CollectionFirmware.fromJson(v)).toList(growable: true == growable);

  static Map<String, CollectionFirmware> mapFromJson(Map<String, dynamic> json) {
    final map = <String, CollectionFirmware>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = CollectionFirmware.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of CollectionFirmware-objects as value to a dart map
  static Map<String, List<CollectionFirmware>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<CollectionFirmware>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = CollectionFirmware.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
