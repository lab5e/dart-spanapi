...
class RetrieveBlobResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RetrieveBlobResponse &&
  ...
  @override
  String toString() => 'RetrieveBlobResponse[contentType=$contentType, size=$size, data=$data]';
  ...
  static List<RetrieveBlobResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(RetrieveBlobResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <RetrieveBlobResponse>[];
  ...
  static Map<String, RetrieveBlobResponse> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = RetrieveBlobResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of RetrieveBlobResponse-objects as value to a dart map
  static Map<String, List<RetrieveBlobResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
