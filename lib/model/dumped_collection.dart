...
class DumpedCollection {
  ...
  @override
  String toString() =>
      'DumpedCollection[collection=$collection, devices=$devices, outputs=$outputs]';
  ...
  static List<DumpedCollection> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <DumpedCollection>[]
          : json
              .map((v) => DumpedCollection.fromJson(v))
  ...
  static Map<String, DumpedCollection> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = DumpedCollection.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of DumpedCollection-objects as value to a dart map
  static Map<String, List<DumpedCollection>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = DumpedCollection.listFromJson(v,
