...
class SendMessageResponse {
  ...
  @override
  String toString() =>
      'SendMessageResponse[collectionId=$collectionId, deviceId=$deviceId, bytesSent=$bytesSent]';
  ...
  static List<SendMessageResponse> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <SendMessageResponse>[]
          : json
              .map((v) => SendMessageResponse.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, SendMessageResponse> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, SendMessageResponse>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = SendMessageResponse.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of SendMessageResponse-objects as value to a dart map
  static Map<String, List<SendMessageResponse>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = SendMessageResponse.listFromJson(v,
