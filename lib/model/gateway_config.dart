...
class GatewayConfig {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GatewayConfig &&
     other.ciot == ciot &&
     other.inet == inet &&
     other.user == user;
  ...
  static List<GatewayConfig> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(GatewayConfig.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <GatewayConfig>[];
  ...
  static Map<String, GatewayConfig> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = GatewayConfig.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GatewayConfig-objects as value to a dart map
  static Map<String, List<GatewayConfig>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
