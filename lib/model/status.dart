...
class Status {
  ...
  static List<Status> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
  ...
  static Map<String, List<Status>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
