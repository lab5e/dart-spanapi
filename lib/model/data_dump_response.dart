...
class DataDumpResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DataDumpResponse &&
  ...
  static List<DataDumpResponse> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <DataDumpResponse>[]
      : json.map((v) => DataDumpResponse.fromJson(v)).toList(growable: true == growable);

  static Map<String, DataDumpResponse> mapFromJson(Map<String, dynamic> json) {
    final map = <String, DataDumpResponse>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = DataDumpResponse.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of DataDumpResponse-objects as value to a dart map
  static Map<String, List<DataDumpResponse>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<DataDumpResponse>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = DataDumpResponse.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
