...
class ListUpstreamMessagesResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ListUpstreamMessagesResponse &&
  ...
  static List<ListUpstreamMessagesResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(ListUpstreamMessagesResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <ListUpstreamMessagesResponse>[];
  ...
  static Map<String, ListUpstreamMessagesResponse> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = ListUpstreamMessagesResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ListUpstreamMessagesResponse-objects as value to a dart map
  static Map<String, List<ListUpstreamMessagesResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
