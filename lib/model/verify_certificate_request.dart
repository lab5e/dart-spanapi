...
class VerifyCertificateRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is VerifyCertificateRequest &&
  ...
  @override
  String toString() => 'VerifyCertificateRequest[gatewayId=$gatewayId, deviceId=$deviceId, certificate=$certificate]';
  ...
  static List<VerifyCertificateRequest> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(VerifyCertificateRequest.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <VerifyCertificateRequest>[];
  ...
  static Map<String, VerifyCertificateRequest> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = VerifyCertificateRequest.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of VerifyCertificateRequest-objects as value to a dart map
  static Map<String, List<VerifyCertificateRequest>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
