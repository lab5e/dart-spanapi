...
class UDPMetadata {
  ...
  @override
  String toString() =>
      'UDPMetadata[localPort=$localPort, remotePort=$remotePort]';
  ...
  static Map<String, UDPMetadata> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = UDPMetadata.fromJson(v));
    }
    return map;
  }
  ...
  static Map<String, List<UDPMetadata>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = UDPMetadata.listFromJson(v,
