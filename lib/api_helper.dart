...
String parameterToString(dynamic value) {
  ...
  if (value is FirmwareManagement) {
    return FirmwareManagementTypeTransformer().encode(value).toString();
  }
  if (value is GatewayStatus) {
    return GatewayStatusTypeTransformer().encode(value).toString();
  }
  ...
  if (value is MessageTransport) {
    return MessageTransportTypeTransformer().encode(value).toString();
  }
  if (value is OutputMessageType) {
    return OutputMessageTypeTypeTransformer().encode(value).toString();
  }
