...
// tests for CollectionFirmware
void main() {
  final instance = CollectionFirmware();

  group('test CollectionFirmware', () {
    // The current firmware is the firmware that the devices are currently using.
    // String currentFirmwareId
    test('to test the property `currentFirmwareId`', () async {
      // TODO
    });
    ...
    test('to test the property `targetFirmwareId`', () async {
      // TODO
    });
